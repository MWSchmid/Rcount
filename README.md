...
<a class="reference external" href="https://github.com/MWSchmid/Rcount/blob/master/Rcount_user_guide.pdf", download = "Rcount_user_guide.pdf">Getting started with Rcount</a>
